// SwAddin1.cpp : Implementation of CSwAddin1
...
// CSwAddin1
void CSwAddin1::AddCommandManager()
{
...
void CSwAddin1::RemoveCommandManager()
{
	iBmp->Dispose();
	iBmp->Release();
...
bool CSwAddin1::CompareIDs(long * storedIDs, long storedSize, long * addinIDs, long addinSize)
{
...
STDMETHODIMP CSwAddin1::OnDocChange(void)
{
...
STDMETHODIMP CSwAddin1::OnFileOpenPostNotify(BSTR fileName)
{
	HRESULT hres = S_OK;
...
STDMETHODIMP CSwAddin1::OnDocLoad(BSTR docTitle, BSTR docPath)
{

	return S_OK;
}
VARIANT_BOOL CSwAddin1::AttachEventHandlers()
{
...
HRESULT CSwAddin1::AttachEventsToAllDocuments()
{
	VARIANT_BOOL attached = VARIANT_TRUE;
	USES_CONVERSION;
	...
	while (iModelDoc2 != NULL)
	{
			...
			{
				ATLTRACE("\tCSwAddin1::DocumentLoadNotify current part not found\n");
...
VARIANT_BOOL CSwAddin1::AttachModelEventHandler(CComPtr<IModelDoc2> iModelDoc2)
{
	VARIANT_BOOL attached = VARIANT_TRUE;
	if (iModelDoc2 == NULL)
		return VARIANT_FALSE;
	...
	if (iter == openDocs.end())
	{
		...
		pDoc->Init((CComObject<CSwAddin1>*)this, iModelDoc2);
...
VARIANT_BOOL CSwAddin1::DetachEventHandlers()
{
...
VARIANT_BOOL CSwAddin1::DetachModelEventHandler(IUnknown *iUnk)
{
	VARIANT_BOOL detached = VARIANT_TRUE;
	TMapIUnknownToDocument::iterator iter;
...
STDMETHODIMP CSwAddin1::OnModelDocChange(void)
{
	// TODO: Add your implementation code here
	return S_OK;
}
...
STDMETHODIMP CSwAddin1::OnFileNew(LPDISPATCH newDoc, long docType, BSTR templateName)
{
	HRESULT hres = S_OK;
	hres = AttachEventsToAllDocuments();
   return hres;
...
STDMETHODIMP CSwAddin1::ConnectToSW(LPDISPATCH ThisSW, long Cookie, VARIANT_BOOL * IsConnected)
{
	...
	iSwApp->SetAddinCallbackInfo((long)_AtlBaseModule.GetModuleInstance(), static_cast<ISwAddin1*>(this), addinID, &status);
...
STDMETHODIMP CSwAddin1::DisconnectFromSW(VARIANT_BOOL * IsDisconnected)
{
...
STDMETHODIMP CSwAddin1::ToolbarCallback0(void)
{
	// TODO: Add your implementation code here

	{
		...
		CSwAddin1Dialog dlg(AfxGetMainWnd());
		dlg.DoModal();
...
STDMETHODIMP CSwAddin1::ToolbarEnable0(long* status)
{
	// TODO: Add your implementation code here
	*status = 1;
	return S_OK;
...
STDMETHODIMP CSwAddin1::FlyoutCallback(void)
{
	CComBSTR tip;
	CComBSTR callback;
	CComBSTR enable;
...
STDMETHODIMP CSwAddin1::FlyoutCallback0(void)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CSwAddin1::FlyoutCallback1(void)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CSwAddin1::FlyoutEnable0(long* status)
{
	// TODO: Add your implementation code here
	*status = 1;
	return S_OK;
...
STDMETHODIMP CSwAddin1::FlyoutEnableCallback0(long* status)
{
	// TODO: Add your implementation code here
	*status = 1;
	return S_OK;
...
STDMETHODIMP CSwAddin1::ShowPMP(void)
{
	// TODO: Add your implementation code here
...
STDMETHODIMP CSwAddin1::EnablePMP(long* status)
{
	*status = 0;
	if (userPropertyPage != NULL)
	{
