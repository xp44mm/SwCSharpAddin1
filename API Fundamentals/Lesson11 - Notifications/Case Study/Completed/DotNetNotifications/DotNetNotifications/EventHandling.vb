...
Public Class DocumentEventHandler
    ...
    Overridable Function Init(ByVal sw As SldWorks,
...
Public Class PartEventHandler
    ...
    Overrides Function Init(ByVal sw As SldWorks,
      ByVal addin As SwAddin, ByVal model As ModelDoc2) _
      As Boolean
        userAddin = addin
        iPart = model
    ...
    Overrides Function AttachEventHandlers() As Boolean
        AddHandler iPart.DestroyNotify,
          AddressOf Me.PartDoc_DestroyNotify
        AddHandler iPart.NewSelectionNotify,
          AddressOf Me.PartDoc_NewSelectionNotify
        ConnectModelViews()
    End Function

    Overrides Function DetachEventHandlers() As Boolean
        RemoveHandler iPart.DestroyNotify,
          AddressOf Me.PartDoc_DestroyNotify
        RemoveHandler iPart.NewSelectionNotify,
          AddressOf Me.PartDoc_NewSelectionNotify
    ...
    Function PartDoc_NewSelectionNotify() As Integer
        iSwApp.SendMsgToUser2(
          ...
          + iDocument.GetTitle + " Part document",
...
Public Class AssemblyEventHandler
    ...
    Overrides Function AttachEventHandlers() As Boolean
        AddHandler iAssembly.DestroyNotify,
          AddressOf Me.AssemblyDoc_DestroyNotify
        AddHandler iAssembly.NewSelectionNotify,
          AddressOf Me.AssemblyDoc_NewSelectionNotify
        AddHandler iAssembly.ComponentStateChangeNotify,
          AddressOf Me.AssemblyDoc_ComponentStateChangeNotify
        AddHandler iAssembly.ComponentStateChangeNotify2,
          AddressOf Me.AssemblyDoc_ComponentStateChangeNotify2
        AddHandler _
          iAssembly.ComponentVisualPropertiesChangeNotify,
          AddressOf _
          Me.AssemblyDoc_ComponentVisiblePropertiesChangeNotify
        AddHandler iAssembly.ComponentDisplayStateChangeNotify,
          AddressOf _
    ...
    Overrides Function DetachEventHandlers() As Boolean
        RemoveHandler iAssembly.DestroyNotify,
          AddressOf Me.AssemblyDoc_DestroyNotify
        RemoveHandler iAssembly.NewSelectionNotify,
          AddressOf Me.AssemblyDoc_NewSelectionNotify
        RemoveHandler iAssembly.ComponentStateChangeNotify,
          AddressOf Me.AssemblyDoc_ComponentStateChangeNotify
        RemoveHandler iAssembly.ComponentStateChangeNotify2,
          AddressOf Me.AssemblyDoc_ComponentStateChangeNotify2
        RemoveHandler _
          iAssembly.ComponentVisualPropertiesChangeNotify,
          AddressOf _
          Me.AssemblyDoc_ComponentVisiblePropertiesChangeNotify
        RemoveHandler _
          iAssembly.ComponentDisplayStateChangeNotify,
          AddressOf _
          Me.AssemblyDoc_ComponentDisplayStateChangeNotify
        DisconnectModelViews()
    ...
    Function AssemblyDoc_NewSelectionNotify() As Integer
        iSwApp.SendMsgToUser2(
          "Something new has been selected in the " _
          + iDocument.GetTitle + " Assembly document",
          swMessageBoxIcon_e.swMbInformation,
          swMessageBoxBtn_e.swMbOk)
    End Function
...
Public Class DrawingEventHandler
    ...
    Overrides Function AttachEventHandlers() As Boolean
        AddHandler iDrawing.DestroyNotify,
          AddressOf Me.DrawingDoc_DestroyNotify
        AddHandler iDrawing.NewSelectionNotify,
          AddressOf Me.DrawingDoc_NewSelectionNotify
        ConnectModelViews()
    End Function

    Overrides Function DetachEventHandlers() As Boolean
        RemoveHandler iDrawing.DestroyNotify,
          AddressOf Me.DrawingDoc_DestroyNotify
        RemoveHandler iDrawing.NewSelectionNotify,
          AddressOf Me.DrawingDoc_NewSelectionNotify
        DisconnectModelViews()
    ...
    Function DrawingDoc_NewSelectionNotify() As Integer
        iSwApp.SendMsgToUser2(
          "Something new has been selected in the " _
          + iDocument.GetTitle + " Drawing document",
          swMessageBoxIcon_e.swMbInformation,
          swMessageBoxBtn_e.swMbOk)
    End Function
End Class
...
Public Class DocView
    ...
    Function Init(ByVal addin As SwAddin,
      ByVal mView As ModelView,
    ...
    Function AttachEventHandlers() As Boolean
        AddHandler iModelView.DestroyNotify2,
          AddressOf Me.ModelView_DestroyNotify2
        AddHandler iModelView.RepaintNotify,
          AddressOf Me.ModelView_RepaintNotify
    End Function

    Function DetachEventHandlers() As Boolean
        RemoveHandler iModelView.DestroyNotify2,
          AddressOf Me.ModelView_DestroyNotify2
        RemoveHandler iModelView.RepaintNotify,
          AddressOf Me.ModelView_RepaintNotify
        parentDoc.DetachModelViewEventHandler(iModelView)
    End Function

    Function ModelView_DestroyNotify2(
      ByVal destroyTYpe As Integer) As Integer
        DetachEventHandlers()
    End Function

    Function ModelView_RepaintNotify(
